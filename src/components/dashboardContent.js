                    ...
                    <div class="col-xxl-12">
                        <div class="promotion d-flex justify-content-between align-items-center">
                            <div class="promotion-detail">
                                <h3 class="text-black mb-3">Discover, Collect, Sell <br/> and Create your Own NFT</h3>
                                <p class="text-black">Digital marketplace for crypto collectibles and non fungable tokens</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6">
                                    ...
                                    <div class="card items">
                                        <div class="card-body">
                                            <div class="items-img position-relative">
                                                ...
                                                <a href="./profile.html"><img src="./images/avatar/1.jpg"
                                                        class="creator" width="50" alt=""/></a>
                                            </div>
                                            <a href="./item.html">
                                    ...
                                    <div class="card items">
                                        <div class="card-body">
                                            <div class="items-img position-relative">
                                                ...
                                                <a href="./profile.html"><img src="./images/avatar/6.jpg"
                                                        class="creator" width="50" alt=""/></a>
                                            </div>
                                            <a href="./item.html">
                                                <h4 class="card-title">Liguid Wave</h4>
                                    ...
                                    <div class="card items">
                                        <div class="card-body">
                                            <div class="items-img position-relative">
                                                ...
                                                <a href="./profile.html"><img src="./images/avatar/7.jpg"
                                                        class="creator" width="50" alt=""/></a>
                                            </div>
                                            <a href="./item.html">
                                                <h4 class="card-title">Liguid Wave</h4>
                                    ...
                                    <div class="card items">
                                        <div class="card-body">
                                            <div class="items-img position-relative">
                                                ...
                                                <a href="./profile.html"><img src="./images/avatar/8.jpg"
                                                        class="creator" width="50" alt=""/></a>
                                            </div>
                                            <a href="./item.html">
                                                <h4 class="card-title">Liguid Wave</h4>
                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-xl-4 col-md-4 col-sm-6">
                                <div class="stat-widget d-flex align-items-center">
                                    ...
                                    <div class="widget-arrow">
                                        <p class="text-success mb-0">+168.001% <span><i
                            ...
                            <div class="col-xxl-12 col-xl-4 col-md-4 col-sm-6">
                                <div class="stat-widget d-flex align-items-center">
                                    ...
                                    <div class="widget-arrow">
                                        <p class="text-danger mb-0">+168.001% <span><i
